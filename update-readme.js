...
const capabilities = {
  ...
  'diffs': 'Diffs & snapshots (opt-in via --caps=diffs)',
  'styles': 'Style/layout tools (opt-in via --caps=styles)',
  'scenarios': 'Scenario runner (opt-in via --caps=scenarios)',
  'perf': 'Performance sensing (opt-in via --caps=perf)',
